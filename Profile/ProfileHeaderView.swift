...
final class ProfileHeaderView: UIView {
    ...
    private func setupUI() {
        ...
        NSLayoutConstraint.activate([
            ...
            avatarImage.heightAnchor.constraint(equalToConstant: 120.0),
            avatarImage.widthAnchor.constraint(equalToConstant: 120.0),

            fullNameLabel.topAnchor.constraint(equalTo: self.topAnchor, constant: 27),
            fullNameLabel.leftAnchor.constraint(equalTo: avatarImage.rightAnchor, constant: 16),
            ...
            statusLabel.leftAnchor.constraint(equalTo: avatarImage.rightAnchor, constant: 16),
            statusLabel.rightAnchor.constraint(equalTo: self.rightAnchor, constant: -16),

            inputText.topAnchor.constraint(equalTo: statusLabel.bottomAnchor, constant: 10),
            inputText.leftAnchor.constraint(equalTo: avatarImage.rightAnchor, constant: 16),
            inputText.rightAnchor.constraint(equalTo: self.rightAnchor, constant: -16),
            inputText.heightAnchor.constraint(equalToConstant: 40.0),

            buttonShowStatus.topAnchor.constraint(equalTo: avatarImage.bottomAnchor, constant: 16),
            ...
            buttonShowStatus.heightAnchor.constraint(equalToConstant: 50.0),
        ])
    }
